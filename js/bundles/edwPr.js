...
var edwPr = function (_Component) {
  _inherits(edwPr, _Component);

  function edwPr() {
    _classCallCheck(this, edwPr);

    return _possibleConstructorReturn(this, (edwPr.__proto__ || Object.getPrototypeOf(edwPr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(edwPr, _step_1Soy2.default);

exports.default = edwPr;
...
exports.templates = exports.edwPr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace edwPr.
   * @public
   */

  goog.module('edwPr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'edwPr.render';
  }
...
_metalSoy2.default.register(edwPr, templates);
exports.edwPr = edwPr;
