...
var vYXql = function (_Component) {
  _inherits(vYXql, _Component);

  function vYXql() {
    _classCallCheck(this, vYXql);

    return _possibleConstructorReturn(this, (vYXql.__proto__ || Object.getPrototypeOf(vYXql)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vYXql, _step_2Soy2.default);

exports.default = vYXql;
...
exports.templates = exports.vYXql = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vYXql.
   * @public
   */

  goog.module('vYXql.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vYXql.render';
  }
...
_metalSoy2.default.register(vYXql, templates);
exports.vYXql = vYXql;
