...
var NnHqd = function (_Component) {
  _inherits(NnHqd, _Component);

  function NnHqd() {
    _classCallCheck(this, NnHqd);

    return _possibleConstructorReturn(this, (NnHqd.__proto__ || Object.getPrototypeOf(NnHqd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NnHqd, _step_9Soy2.default);

exports.default = NnHqd;
...
exports.templates = exports.NnHqd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NnHqd.
   * @public
   */

  goog.module('NnHqd.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NnHqd.render';
  }
...
_metalSoy2.default.register(NnHqd, templates);
exports.NnHqd = NnHqd;
