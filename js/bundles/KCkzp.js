...
var KCkzp = function (_Component) {
  _inherits(KCkzp, _Component);

  function KCkzp() {
    _classCallCheck(this, KCkzp);

    return _possibleConstructorReturn(this, (KCkzp.__proto__ || Object.getPrototypeOf(KCkzp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(KCkzp, _indexSoy2.default);

exports.default = KCkzp;
...
exports.templates = exports.KCkzp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace KCkzp.
   * @public
   */

  goog.module('KCkzp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'KCkzp.render';
  }
...
_metalSoy2.default.register(KCkzp, templates);
exports.KCkzp = KCkzp;
