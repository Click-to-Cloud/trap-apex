...
var XQNMX = function (_Component) {
  _inherits(XQNMX, _Component);

  function XQNMX() {
    _classCallCheck(this, XQNMX);

    return _possibleConstructorReturn(this, (XQNMX.__proto__ || Object.getPrototypeOf(XQNMX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XQNMX, _indexSoy2.default);

exports.default = XQNMX;
...
exports.templates = exports.XQNMX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XQNMX.
   * @public
   */

  goog.module('XQNMX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XQNMX.render';
  }
...
_metalSoy2.default.register(XQNMX, templates);
exports.XQNMX = XQNMX;
