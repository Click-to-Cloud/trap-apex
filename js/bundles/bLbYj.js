...
var bLbYj = function (_Component) {
  _inherits(bLbYj, _Component);

  function bLbYj() {
    _classCallCheck(this, bLbYj);

    return _possibleConstructorReturn(this, (bLbYj.__proto__ || Object.getPrototypeOf(bLbYj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bLbYj, _step_10Soy2.default);

exports.default = bLbYj;
...
exports.templates = exports.bLbYj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bLbYj.
   * @public
   */

  goog.module('bLbYj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bLbYj.render';
  }
...
_metalSoy2.default.register(bLbYj, templates);
exports.bLbYj = bLbYj;
