...
var rHQEI = function (_Component) {
  _inherits(rHQEI, _Component);

  function rHQEI() {
    _classCallCheck(this, rHQEI);

    return _possibleConstructorReturn(this, (rHQEI.__proto__ || Object.getPrototypeOf(rHQEI)).apply(this, arguments));
  }
...
_metalSoy2.default.register(rHQEI, _step_3Soy2.default);

exports.default = rHQEI;
...
exports.templates = exports.rHQEI = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace rHQEI.
   * @public
   */

  goog.module('rHQEI.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'rHQEI.render';
  }
...
_metalSoy2.default.register(rHQEI, templates);
exports.rHQEI = rHQEI;
