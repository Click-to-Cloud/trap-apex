...
var ZfEMF = function (_Component) {
  _inherits(ZfEMF, _Component);

  function ZfEMF() {
    _classCallCheck(this, ZfEMF);

    return _possibleConstructorReturn(this, (ZfEMF.__proto__ || Object.getPrototypeOf(ZfEMF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZfEMF, _functionSoy2.default);

exports.default = ZfEMF;
...
exports.templates = exports.ZfEMF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZfEMF.
   * @public
   */

  goog.module('ZfEMF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZfEMF.render';
  }
...
_metalSoy2.default.register(ZfEMF, templates);
exports.ZfEMF = ZfEMF;
