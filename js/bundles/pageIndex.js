...
goog.loadModule(function (exports) {
  ...
  function $header(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('a', null, null, 'href', '/trap-apex/tutorials/getting_started/step_1.html', 'class', 'btn btn-accent btn-sm');
    itext('Get Started');
    ie_close('a');
    ie_open('a', null, null, 'href', 'https://github.com/Click-to-Cloud/Trap.apex/', 'class', 'btn btn-success btn-sm');
    itext('GitHub');
    ie_close('a');
  ...
  function $features(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Trap.apex adopts the functional reactive style to process trigger logic.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    itext('Trigger Control');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Trap.apex offers fine control over trigger handlers.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    ...
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Trap.apex can be used with other trigger frameworks.');
    ie_close('p');
    ie_close('section');
    ie_close('div');
    ie_close('div');
  ...
  function $how(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('div', null, null, 'class', 'col-md-12 col-md-offset-2');
    ie_open('h3', null, null, 'class', 'about-title');
    itext('Triggers in Functional Style');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext('Trap.apex is not a monster. It just puts your triggers into a functional style.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $highlights(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Trap.apex uses stream-based API to handle trigger logic.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/trap-apex/images/highlight_1.png', 'alt', 'Stream Style', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ...
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Trap.apex executes fine controls over trigger handlers.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-2 col-md-pull-6');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/trap-apex/images/highlight_2.png', 'alt', 'Trigger Control', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ie_open('div', null, null, 'class', 'col-md-6 col-md-offset-2');
    ie_open('h4', null, null, 'class', 'highlight-title');
    itext('Easy Unit Test');
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Trap.apex makes it easy to do unit test with triggers.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/trap-apex/images/highlight_3.png', 'alt', 'Easy Unit Test', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_close('div');
