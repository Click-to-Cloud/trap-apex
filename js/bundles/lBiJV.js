...
var lBiJV = function (_Component) {
  _inherits(lBiJV, _Component);

  function lBiJV() {
    _classCallCheck(this, lBiJV);

    return _possibleConstructorReturn(this, (lBiJV.__proto__ || Object.getPrototypeOf(lBiJV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lBiJV, _step_8Soy2.default);

exports.default = lBiJV;
...
exports.templates = exports.lBiJV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lBiJV.
   * @public
   */

  goog.module('lBiJV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lBiJV.render';
  }
...
_metalSoy2.default.register(lBiJV, templates);
exports.lBiJV = lBiJV;
