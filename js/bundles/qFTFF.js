...
var qFTFF = function (_Component) {
  _inherits(qFTFF, _Component);

  function qFTFF() {
    _classCallCheck(this, qFTFF);

    return _possibleConstructorReturn(this, (qFTFF.__proto__ || Object.getPrototypeOf(qFTFF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qFTFF, _data_sharingSoy2.default);

exports.default = qFTFF;
...
exports.templates = exports.qFTFF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qFTFF.
   * @public
   */

  goog.module('qFTFF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qFTFF.render';
  }
...
_metalSoy2.default.register(qFTFF, templates);
exports.qFTFF = qFTFF;
