...
var wRTxi = function (_Component) {
  _inherits(wRTxi, _Component);

  function wRTxi() {
    _classCallCheck(this, wRTxi);

    return _possibleConstructorReturn(this, (wRTxi.__proto__ || Object.getPrototypeOf(wRTxi)).apply(this, arguments));
  }
...
_metalSoy2.default.register(wRTxi, _step_5Soy2.default);

exports.default = wRTxi;
...
exports.templates = exports.wRTxi = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace wRTxi.
   * @public
   */

  goog.module('wRTxi.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'wRTxi.render';
  }
...
_metalSoy2.default.register(wRTxi, templates);
exports.wRTxi = wRTxi;
